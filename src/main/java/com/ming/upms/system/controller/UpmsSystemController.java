...
import com.ming.upms.common.util.PageUtils;
import com.ming.upms.common.util.Query;
...
public class UpmsSystemController {
    ...
    @GetMapping()
    @RequiresPermissions("system:upmsSystem:read")
    public String UpmsSystem() {
    ...
    public String edit(@PathVariable("systemId") Long systemId, Model model) {
