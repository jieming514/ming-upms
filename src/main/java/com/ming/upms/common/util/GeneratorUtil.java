...
public class GeneratorUtil {
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns,
        ...
        tableDO.setComments(table.get("tableComment"));//备注
        String className = tableToJava(tableDO.getTableName(),config.getString("autoRemovePre"));
     ...
     * 表名转换成Java类名
     */
    public static String tableToJava(String tableName, String autoRemovePre) {
